---
name: playwright-cli
description: Use playwright-cli for browser automation, snapshots, screenshots, and session-based testing from Pi.
compatibility: pi
---
...
Prefer `playwright-cli` over browser MCP unless the task specifically needs MCP behavior.
