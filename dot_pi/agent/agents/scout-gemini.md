---
name: scout-gemini
description: Read-only static codebase reconnaissance with Gemini 3.6 Flash via Google Vertex; never runs commands or drives infrastructure
tools: read, grep, find, ls
model: google-vertex/gemini-3.6-flash:high
---
