...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		description: [
			...
			'"scout" uses Google Vertex Gemini 3.8 Flash at high reasoning; "worker-lite" uses Google Vertex Gemini 3.8 Flash at high reasoning; "worker" uses OpenAI Codex Sol with optional effort=low/medium/high (default medium); "browser" uses OpenAI Codex Luna.',
