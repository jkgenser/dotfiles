...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		description: [
			...
			'Use "scout-dsflash" as the default scout, only for read-only static codebase reconnaissance with read/grep/find/ls; never delegate shell commands, SQL/database operations, Docker, or other infrastructure/runtime actions to it—the main agent must perform those directly. Use "worker-lite" for straightforward bounded implementation, "worker" for nontrivial or risky implementation, "worker-dsflash" for implementation tasks using DeepSeek V4.1 Flash, and "browser" for Playwright-driven UI investigation, testing, and verification.',
			'"scout-dsflash" uses direct DeepSeek V4.1 Flash at high reasoning; "worker-lite" uses Google Vertex Gemini 3.8 Flash at high reasoning; "worker" uses Google Vertex Gemini 3.8 Flash with optional effort=low/medium/high (default high); "worker-dsflash" uses direct DeepSeek V4.1 Flash at high reasoning; "browser" uses OpenAI Codex Luna.',
